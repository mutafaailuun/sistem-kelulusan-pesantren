...
<div class="container" style="height: 100%; display: flex; justify-content: center; align-items: center;">
    <div style="top: 50%; transform:translate(0, -50%); position: absolute;">
        <div class="well" style="margin-top: 0px;">
            ...
            <h4 align="center" style="margin: 15px 0 -10px 0;">PENGUMUMAN KELULUSAN SPMB DARUS-SUNNAH 2023</h4>
            <?php require_once "setting-tgl.php" ?>
            <div class="form-group" style="margin-bottom: -10px;">
                <p align="center"><a href="caridata" class="btn btn-danger" value=""><span
                            class='glyphicon glyphicon-check' aria-hidden='true'></span>&nbsp;<b>CEK KELULUSAN</b></a>
                </p>
            </div>
        </div>
        </br>
