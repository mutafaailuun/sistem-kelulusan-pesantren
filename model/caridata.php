...
<head>
    ...
    <title>PENGUMUMAN SPMB DARUS-SUNNAH 2023</title>
                ...
                <td style="padding: 10px;">
                    ...
                    <div class="container"
                        ...
                        <div style="top: 50%; transform:translate(0, -50%); position: absolute;">
                            <div class="well">
                                <p align="center"><img src="images/logo-putih.png"
                                        style="background-color: rgb(20, 115, 113); padding: 8px; border-radius: 50%"
                                        height="75" /></p>
                                <h4 align="center" style="margin: 15px 0 -10px 0;"><b>PENGUMUMAN KELULUSAN</br>SPMB
                                        DARUS-SUNNAH 2023</b></h4>
                                <hr>
                                <script>
                                function cekNo() {
                                    var cek = document.forms['formcarino']['nisn'].value;
                                    if (cek == null || cek == "") {
                                        alert("SILAHKAN MASUKKAN NOMOR PESERTA");
                                        return false;
                                    }
                                }
                                </script>
                                ...
                                <div id="xpengumuman">
                                    <div class="alert alert-dismissable alert-success">
                                        <h4 align="center">
                                            <b>PENGUMUMAN STATUS KELULUSAN</br>TAHUN
                                                <?= $tahun ?> DIBUKA
                                            </b>
                                        </h4>
                                    </div>
                                    <hr>
                                    <form class="form-horizontal" form name="formcarino" method="post" action="carinisn"
                                        onSubmit="return cekNo()">
                                        <fieldset id="xpengumuman">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="nisn"
                                                    placeholder="KETIK/MASUKKAN NOMOR PESERTA" size="auto">
                                            </div>
                                            <div class="form-group" style="margin-bottom: -10px;">
                                                <p align="center"><b><input type="SUBMIT" name="SUBMIT" id="SUBMIT"
                                                            value="PERIKSA DATA" class="btn btn-danger"></b></p>
                                            </div>
                                        </fieldset>
                                    </form>
